...
Pilih Angka: """)
        if pilih == '1':
            ...
            if konfirmasi == 'Y':
                ...
                print("Data baru batal ditambahkan!")
...
def prosesBooking():
    ...
    while True:
        ...
        jumlah_input = input("Jumlah Mobil: ")       
        ...
        hari_input = input("Lama Sewa (Hari): ")
...
def prosesPembayaran(cart):
    ...
    while True:
        ...
        if not bayar_input.isdigit():
            print("Input salah! Masukkan angka tanpa koma atau tanpa titik")
            continue
